...
The code was tested on Ubuntu 16.04, with [Anaconda](https://www.anaconda.com/download) Python 3.6, [PyTorch]((http://pytorch.org/)) v0.4.1, [Numpy](https://numpy.org/) v1.17.2 and [Pillow](https://pypi.org/project/Pillow/) v6.2.0. NVIDIA GPUs are needed for both training and testing.
